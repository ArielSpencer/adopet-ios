...
class PetsListViewController: UIViewController {
    ...
    var data: [Pet] = []
    private var dataService = PetsDataServices(networkservice: URLSessionNetworking())
...
extension PetsListViewController: PetsDataServicesDelegate {
